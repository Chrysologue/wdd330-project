export class Service {
    ...
    renderServices(servicesToRender) {
        ...
        if (!servicesToRender || servicesToRender.length === 0) {
            this.parentElement.innerHTML = '<p class="no-services-message">No services found matching your criteria.</p>';
            return;
        }
    ...
    async init() {
        ...
        if (this.searchInput) {
            this.searchInput.addEventListener('input', this.filterServices.bind(this));
        }
